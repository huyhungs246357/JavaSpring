                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach var="oh" items="${orderh}">
                                    <tr>
                                        ...
                                        <td>
                                            <button style="margin-bottom: 10px; " class="btn btn-info" onclick="location.href = '${pageContext.request.getContextPath()}/user/view_orderdetail/${oh.id}'">View Detail</button>
                                        </td>
                                    </tr>
                                </c:forEach>
